...
class MainPage extends React.Component {
  ...
  renderPrediction() {
    ...
    if (predictions.length > 0) {
      const predictionItems = predictions.map((item, ind) => {
        <li>
      ...
      <div>
        ...
        <Form>
            ...
            <div>
              ...
              <div>
                <UncontrolledDropdown>
                  <DropdownToggle caret>Sample Image Url</DropdownToggle>
                  <DropdownMenu>
                    {sampleImages.map(si => (
          ...
          <FormGroup id={'upload_button'}>
            <div>
              <p>Upload an image (.png, .jpg, .jpeg)</p>
            </div>
          ...
          <img
            ...
            hidden={!this.state.imageSelected}
          />
          ...
          <FormGroup>
            ...
            <span className="p-1 " />
            <Button color="danger" onClick={this._clear}>
              {' '}
              Clear
            </Button>
          </FormGroup>
